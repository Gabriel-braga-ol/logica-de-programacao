...
while True:
    if valor >= 100:
        cont100 = valor // 100  #somente a parte inteira da divisão
    ...
    if valor >= 50:
        cont50 = valor // 50 #somente a parte inteira da divisão
    ...
    if valor >= 20:
        cont20 = valor // 20 #somente a parte inteira da divisão
    ...
    if valor >= 10:
        cont10 = valor // 10 #somente a parte inteira da divisão
    ...
    if valor >= 5:
        cont5 = valor // 5 #somente a parte inteira da divisão
        valor = valor - cont5 * 5
